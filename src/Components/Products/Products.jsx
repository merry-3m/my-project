...
import P2 from "../../assets/fanta2.png"; //:Cola zero
import P3 from "../../assets/fanta3.png"; //:Coca Cola
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {ProductData.map((item) => (
            <motion.div
             ...
             initial="hidden"
             whileInView={"show"}
             className="flex flex-col justify-center items-center p-5 max-w-[300px] mx-auto rounded-xl bg-white  shadow-lg">
              <img
